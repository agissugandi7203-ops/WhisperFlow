...
export const MagicVideoWindow: React.FC = () => {
  return (
    ...
    >
      {/* Magical Ambient Aura & Neon Rays (Desktop only to prevent mobile GPU lag) */}
      <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[1000px] h-[650px] bg-gradient-to-tr from-indigo-600/20 via-purple-600/15 to-cyan-500/20 rounded-full blur-[150px] pointer-events-none" />
